...
import TheRoarTabCartItemComponent from '../components/TheRoarTabCartItemComponent';
import TheRoarComponent from '../components/TheRoarComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <TheRoarTabCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
