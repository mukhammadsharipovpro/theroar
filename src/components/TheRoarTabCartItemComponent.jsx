...
import {kansasBBQ} from '../assets/products';

const TheRoarTabCartItemComponent = ({item}) => {
  ...
  const productImage = kansasBBQ.find(p => p.name === item.name)?.image;
...
export default TheRoarTabCartItemComponent;
